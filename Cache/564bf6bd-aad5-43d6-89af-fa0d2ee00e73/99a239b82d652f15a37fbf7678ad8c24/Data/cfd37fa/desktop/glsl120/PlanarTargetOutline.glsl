...
l9_33=varTangent.xyz;
l9_32=l9_30;
l9_31=(sc_ModelMatrix*vec4(((sc_ModelMatrixInverse*vec4(varPos,1.0)).xyz*vec3(lineWeight+1.0))+vec3(Port_Input2_N017),1.0)).xyz;
}
varPos=l9_31;
...
#endif
float l9_0=clamp(lineWeight+0.001,Port_Input1_N008+0.001,Port_Input2_N008+0.001)-0.001;
vec2 l9_1=step(vec2(1.0-l9_0),varPackedTex.xy);
vec2 l9_2=step(varPackedTex.xy,vec2(l9_0));
vec4 l9_3=vec4(max(max(l9_1.x,l9_1.y),max(l9_2.x,l9_2.y)))*lineColor;
float l9_4=l9_3.w;
...
{
l9_8=clamp(dot(l9_3.xyz,vec3(l9_4)),0.0,1.0);
}
#else
{
float l9_9;
...
{
l9_10=(1.0-dot(l9_3.xyz,vec3(0.33333001)))*l9_4;
}
#else
{
float l9_11;
...
{
l9_11=(1.0-clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0))*l9_4;
}
#else
{
float l9_12;
...
{
l9_12=clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0)*l9_4;
}
#else
{
float l9_13;
#if (sc_BlendMode_Add)
{
l9_13=clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_14;
...
{
l9_15=dot(l9_3.xyz,vec3(0.33333001))*l9_4;
}
#else
{
float l9_16;
#if (sc_BlendMode_Min)
{
l9_16=1.0-clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_17;
#if (sc_BlendMode_Max)
{
l9_17=clamp(dot(l9_3.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_17=1.0;
...
#endif
l9_5=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_3.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_6);
}
#else
{
vec4 l9_18;
...
#endif
l9_20=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_24,sc_ScreenTextureLayout,l9_25).xy,0.0);
}
#endif
vec4 l9_26;
...
#endif
vec3 l9_28=mix(l9_26.xyz,definedBlend(l9_26.xyz,l9_3.xyz).xyz,vec3(l9_4));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_30=vec4(mix(vec3(1.0),l9_3.xyz,vec3(l9_4)),l9_4);
}
#else
{
vec4 l9_31;
