...
//float Port_Input2_N017 4032
//float Port_Input1_N008 4036
//float Port_Input2_N008 4040
//}
...
float3 Position_N15=float3(0.0);
Position_N15=Globals.SurfacePosition_ObjectSpace;
float Output_N1=0.0;
float param_1=(*sc_set0.UserUniforms).lineWeight;
Output_N1=param_1;
float Output_N16=0.0;
Output_N16=Output_N1+1.0;
float3 Output_N17=float3(0.0);
Output_N17=(Position_N15*float3(Output_N16))+float3((*sc_set0.UserUniforms).Port_Input2_N017);
float3 VectorOut_N18=float3(0.0);
VectorOut_N18=((*sc_set0.UserUniforms).sc_ModelMatrix*float4(Output_N17,1.0)).xyz;
WorldPosition=VectorOut_N18;
if ((*sc_set0.UserUniforms).PreviewEnabled==1)
{
...
float Output_N1=0.0;
float param=(*sc_set0.UserUniforms).lineWeight;
Output_N1=param;
float Output_N8=0.0;
Output_N8=fast::clamp(Output_N1+0.001,(*sc_set0.UserUniforms).Port_Input1_N008+0.001,(*sc_set0.UserUniforms).Port_Input2_N008+0.001)-0.001;
float Output_N0=0.0;
Output_N0=1.0-Output_N8;
float2 UVCoord_N3=float2(0.0);
UVCoord_N3=Globals.Surface_UVCoord0;
float2 Output_N2=float2(0.0);
Output_N2=step(float2(Output_N0),UVCoord_N3);
float Output_N10=0.0;
Output_N10=Output_N2.x;
float Output_N12=0.0;
Output_N12=Output_N2.y;
float Output_N13=0.0;
Output_N13=fast::max(Output_N10,Output_N12);
float2 Output_N9=float2(0.0);
Output_N9=step(UVCoord_N3,float2(Output_N8));
float Output_N11=0.0;
Output_N11=Output_N9.x;
float Output_N19=0.0;
Output_N19=Output_N9.y;
float Output_N7=0.0;
Output_N7=fast::max(Output_N11,Output_N19);
float Output_N14=0.0;
Output_N14=fast::max(Output_N13,Output_N7);
float4 Output_N5=float4(0.0);
float4 param_1=(*sc_set0.UserUniforms).lineColor;
Output_N5=param_1;
float4 Output_N21=float4(0.0);
Output_N21=float4(Output_N14)*Output_N5;
...
{
l9_17.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
float4 l9_18=l9_17;
l9_15=l9_18;
}
...
float3 l9_54=l9_53;
float3 l9_55=l9_54;
float2 l9_56=l9_55.xy;
float l9_57=l9_49;
float4 l9_58=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_56,bias(l9_57));
float4 l9_59=l9_58;
l9_45=l9_59;
float4 l9_60=l9_45;
float4 l9_61=l9_60;
...
float4 l9_63=l9_15;
float4 l9_64=l9_63;
float3 l9_65=l9_64.xyz;
float3 l9_66=l9_65;
float3 l9_67=l9_13.xyz;
float3 l9_68=definedBlend(l9_66,l9_67,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
l9_14=float4(l9_68.x,l9_68.y,l9_68.z,l9_14.w);
float3 l9_69=mix(l9_65,l9_14.xyz,float3(l9_13.w));
l9_14=float4(l9_69.x,l9_69.y,l9_69.z,l9_14.w);
l9_14.w=1.0;
float4 l9_70=l9_14;
param_3=l9_70;
}
...
{
l9_76=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_76=float4(0.0);
