...
//float4 handGlowTexSize 4160
//float4 handGlowTexDims 4176
//float4 handGlowTexView 4192
//float3x3 handGlowTexTransform 4208
//float4 handGlowTexUvMinMax 4256
//float4 handGlowTexBorderColor 4272
//float brightness 4288
//float4 Port_Input0_N003 4304
//float depthRef 4320
//}
...
float3x3 param_4=(*sc_set0.UserUniforms).handGlowTexTransform;
...
float4 param_7=(*sc_set0.UserUniforms).handGlowTexUvMinMax;
bool param_8=(int(SC_USE_CLAMP_TO_BORDER_handGlowTex_tmp)!=0);
float4 param_9=(*sc_set0.UserUniforms).handGlowTexBorderColor;
float param_10=0.0;
...
Color_N1=l9_86;
float Output_N5=0.0;
float param_11=(*sc_set0.UserUniforms).brightness;
Output_N5=param_11;
float4 Output_N3=float4(0.0);
Output_N3=mix((*sc_set0.UserUniforms).Port_Input0_N003,Color_N1,float4(Output_N5));
