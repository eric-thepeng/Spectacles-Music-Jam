...
#endif
vec4 l9_26=Tweak_N12*l9_25;
float l9_27=l9_0*Tweak_N15;
float l9_28=(((sin(l9_27)-Port_RangeMinA_N010)/(Port_RangeMaxA_N010-Port_RangeMinA_N010))*(Port_RangeMaxB_N010-Port_RangeMinB_N010))+Port_RangeMinB_N010;
vec4 l9_29=baseColor*l9_25;
vec3 l9_30=l9_26.xyz*l9_28;
vec3 l9_31;
#if (!sc_ProjectiveShadowsCaster)
{
l9_31=normalize(varNormal);
}
#else
{
l9_31=vec3(0.0);
...
#endif
float l9_32=clamp(l9_29.w,0.0,1.0);
...
#endif
vec3 l9_33=max((vec4(l9_30.x,l9_30.y,l9_30.z,vec4(0.0).w)+(l9_29*(1.0-l9_28))).xyz,vec3(0.0));
vec4 l9_34;
#if (sc_ProjectiveShadowsCaster)
{
...
#else
{
float l9_35=clamp(metallic,0.0,1.0);
float l9_36=clamp(roughness,0.0,1.0);
vec3 l9_37=ssSRGB_to_Linear(l9_33);
vec3 l9_38=normalize(l9_31);
vec3 l9_39=ssSRGB_to_Linear(Port_Emissive_N006);
vec3 l9_40;
#if (sc_SSAOEnabled)
{
...
SurfaceProperties l9_44=SurfaceProperties(l9_43,l9_32,l9_38,varPos,l9_1,l9_35,l9_36,l9_39,l9_40,Port_SpecularAO_N006,vec3(1.0),l9_42);
vec4 l9_45=vec4(1.0);
vec3 l9_46;
vec3 l9_47;
vec3 l9_48;
...
{
LightingComponents l9_65=accumulateLight(LightingComponents(l9_53,l9_54,l9_59,l9_58,l9_56,l9_55),LightProperties(sc_DirectionalLights[l9_64].direction,sc_DirectionalLights[l9_64].color.xyz,sc_DirectionalLights[l9_64].color.w*l9_45[(l9_57<3) ? l9_57 : 3]),l9_44,l9_1);
...
l9_75=l9_83+1;
LightingComponents l9_90=accumulateLight(LightingComponents(l9_69,l9_70,l9_74,l9_73,l9_72,l9_71),LightProperties(l9_85,sc_PointLights[l9_82].color.xyz,l9_89),l9_44,l9_1);
...
vec2 l9_133=calcPanoramicTexCoordsFromDir(getSpecularDominantDir(l9_38,reflect(-l9_1,l9_38),l9_36),sc_EnvmapRotation.y);
vec4 l9_134;
#if ((SC_DEVICE_CLASS>=2)&&SC_GL_FRAGMENT_PRECISION_HIGH)
{
...
#endif
l9_131=vec3(0.0)+((((l9_134.xyz*(1.0/l9_134.w))*sc_EnvmapExposure)+vec3(1e-06))*envBRDFApprox(l9_44,abs(dot(l9_38,l9_1))));
}
#else
{
l9_131=vec3(0.0);
...
vec3 l9_142=reflect(-l9_1,l9_38);
float l9_143=dot(l9_38,l9_1);
...
#endif
vec4 l9_170=max(l9_34,vec4(0.0));
vec4 l9_171;
#if (sc_ProjectiveShadowsCaster)
{
float l9_172;
