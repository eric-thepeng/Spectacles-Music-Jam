...
//}
//ubo int UserUniforms 0:41:4736 {
...
//float Tweak_N15 4592
//float4 baseColor 4608
//float metallic 4624
//float roughness 4628
//float Port_RangeMinA_N010 4632
//float Port_RangeMaxA_N010 4636
//float Port_RangeMinB_N010 4640
//float Port_RangeMaxB_N010 4644
//float Port_Mask_N013 4648
//float3 Port_Normal_N006 4656
//float3 Port_Emissive_N006 4672
...
Output_N8=Output_N12*Output_N1;
float Output_N15=0.0;
float param_12=(*sc_set0.UserUniforms).Tweak_N15;
Output_N15=param_12;
float Time_N11=0.0;
...
Value_N14=float4(Output_N8.xyz.x,Output_N8.xyz.y,Output_N8.xyz.z,Value_N14.w);
Value_N14.w=ValueOut_N10;
...
float4 param_15=Value_N14;
float4 param_16=Output_N3;
float4 l9_87=param_15;
float4 l9_88=param_16;
float3 l9_89=l9_87.xyz*l9_87.w;
l9_87=float4(l9_89.x,l9_89.y,l9_89.z,l9_87.w);
float4 param_14=l9_87+(l9_88*(1.0-l9_87.w));
Output_N13=param_14;
float Output_N7=0.0;
Output_N7=Output_N3.w;
float Output_N2=0.0;
float param_17=(*sc_set0.UserUniforms).metallic;
Output_N2=param_17;
float Output_N0=0.0;
float param_18=(*sc_set0.UserUniforms).roughness;
Output_N0=param_18;
float4 Output_N6=float4(0.0);
float3 param_19=Output_N13.xyz;
float param_20=Output_N7;
float3 param_21=(*sc_set0.UserUniforms).Port_Emissive_N006;
float param_22=Output_N2;
float param_23=Output_N0;
float3 param_24=(*sc_set0.UserUniforms).Port_AO_N006;
float3 param_25=(*sc_set0.UserUniforms).Port_SpecularAO_N006;
ssGlobals param_27=Globals;
if (!(int(sc_ProjectiveShadowsCaster_tmp)!=0))
{
param_27.BumpedNormal=param_27.VertexNormal_WorldSpace;
}
param_20=fast::clamp(param_20,0.0,1.0);
float l9_90=param_20;
if ((int(sc_BlendMode_AlphaTest_tmp)!=0))
{
if (l9_90<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
float4 l9_105=fast::max(param_28,float4(0.0));
float4 param_29=l9_105;
if (sc_ShaderCacheConstant_tmp!=0)
{
...
Output_N1=l9_81;
float4 Output_N5=float4(0.0);
float4 param_11=(*sc_set0.UserUniforms).baseColor;
Output_N5=param_11;
float4 Output_N3=float4(0.0);
Output_N3=Output_N5*Output_N1;
float Output_N7=0.0;
