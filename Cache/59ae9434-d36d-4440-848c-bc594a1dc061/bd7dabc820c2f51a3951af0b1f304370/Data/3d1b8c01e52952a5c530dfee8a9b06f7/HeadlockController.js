...
class DefaultHeadlockController {
    ...
    // TODO: Propagate to SIK.
    resetPosition() {
        const xzEasing = this.xzEasing;
        const yEasing = this.yEasing;
        const pitchEasing = this.pitchEasing;
        const yawEasing = this.yawEasing;
        this.xzEasing = 1;
        this.yEasing = 1;
        this.pitchEasing = 1;
        this.yawEasing = 1;
        ...
        // );
        this.onUpdate();
        this.xzEasing = xzEasing;
        this.yEasing = yEasing;
