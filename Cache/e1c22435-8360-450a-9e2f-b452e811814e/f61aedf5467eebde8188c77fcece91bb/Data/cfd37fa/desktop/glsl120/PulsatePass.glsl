...
float l9_1=l9_0*Tweak_N15;
float l9_2=((((sin(l9_1)-Port_RangeMinA_N010)/(Port_RangeMaxA_N010-Port_RangeMinA_N010))*(Port_RangeMaxB_N010-Port_RangeMinB_N010))+Port_RangeMinB_N010)*strength;
vec4 l9_3=vec4(Tweak_N12.x,Tweak_N12.y,Tweak_N12.z,vec4(0.0).w);
l9_3.w=l9_2;
