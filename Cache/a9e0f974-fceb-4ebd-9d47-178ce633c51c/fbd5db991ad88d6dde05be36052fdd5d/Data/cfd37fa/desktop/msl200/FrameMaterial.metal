...
//}
//ubo int UserUniforms 0:26:4624 {
...
//float opacity 4244
//float Port_Input1_N021 4248
//float Port_Input2_N014 4252
//float Port_Input1_N018 4256
//float Port_Input1_N002 4260
//float Port_Input2_N019 4264
//float Port_Input1_N008 4268
//float Port_Input2_N023 4272
...
constant int SC_SOFTWARE_WRAP_MODE_U_matcapTexture [[function_constant(70)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_matcapTexture [[function_constant(72)]];
...
constant int intensityTextureLayout [[function_constant(73)]];
constant int intensityTextureLayout_tmp = is_function_constant_defined(intensityTextureLayout) ? intensityTextureLayout : 0;
constant int matcapTextureLayout [[function_constant(74)]];
...
int l9_133=l9_132;
l9_131=((*sc_set0.UserUniforms).sc_ModelViewMatrixArray[l9_133]*param_13.position)*float4(1.0/(*sc_set0.UserUniforms).sc_Camera.aspect,1.0,1.0,1.0);
}
else
{
if (sc_RenderingSpace_tmp==2)
...
{
float4 l9_138=param_13.position;
...
int l9_3=l9_2;
Globals.SurfacePosition_ViewSpace=((*sc_set0.UserUniforms).sc_ViewMatrixArray[l9_3]*float4(in.varPos,1.0)).xyz;
...
int l9_5=l9_4;
Globals.VertexNormal_ViewSpace=normalize(((*sc_set0.UserUniforms).sc_ViewMatrixArray[l9_5]*float4(Globals.VertexNormal_WorldSpace,0.0)).xyz);
...
{
l9_7=pow(ValueOut_N112,(*sc_set0.UserUniforms).Port_Input1_N072);
}
Output_N72=l9_7;
...
{
l9_9=pow(ValueOut_N53,(*sc_set0.UserUniforms).Port_Input1_N160);
}
Output_N160=l9_9;
...
float3x3 l9_48=(*sc_set0.UserUniforms).matcapTextureTransform;
...
float4 l9_51=(*sc_set0.UserUniforms).matcapTextureUvMinMax;
bool l9_52=(int(SC_USE_CLAMP_TO_BORDER_matcapTexture_tmp)!=0);
float4 l9_53=(*sc_set0.UserUniforms).matcapTextureBorderColor;
float l9_54=0.0;
...
float l9_124=l9_116;
float4 l9_125=sc_set0.matcapTexture.sample(sc_set0.matcapTextureSmpSC,l9_123,bias(l9_124));
...
{
l9_130=pow(Output_N109,(*sc_set0.UserUniforms).Port_Input1_N087);
}
Output_N87=l9_130;
...
ValueOut_N129=(((Output_N74-(*sc_set0.UserUniforms).Port_RangeMinA_N129)/((*sc_set0.UserUniforms).Port_RangeMaxA_N129-(*sc_set0.UserUniforms).Port_RangeMinA_N129))*((*sc_set0.UserUniforms).Port_RangeMaxB_N129-(*sc_set0.UserUniforms).Port_RangeMinB_N129))+(*sc_set0.UserUniforms).Port_RangeMinB_N129;
...
Output_N93=step(Output_N89,(*sc_set0.UserUniforms).Port_Input1_N093);
...
{
if (param_64<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
FinalColor=outputMotionVectorsIfNeeded(param_66,param_67,in.varStereoViewID,(*sc_set0.UserUniforms));
