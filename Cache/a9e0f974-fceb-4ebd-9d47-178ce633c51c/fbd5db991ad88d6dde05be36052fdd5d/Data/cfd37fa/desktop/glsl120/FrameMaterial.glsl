...
#endif
float l9_47=l9_45.x;
sc_SoftwareWrapEarly(l9_47,ivec2(SC_SOFTWARE_WRAP_MODE_U_matcapTexture,SC_SOFTWARE_WRAP_MODE_V_matcapTexture).x);
float l9_48=l9_47;
float l9_49=l9_45.y;
sc_SoftwareWrapEarly(l9_49,ivec2(SC_SOFTWARE_WRAP_MODE_U_matcapTexture,SC_SOFTWARE_WRAP_MODE_V_matcapTexture).y);
float l9_50=l9_49;
vec2 l9_51;
float l9_52;
...
{
l9_53=ivec2(SC_SOFTWARE_WRAP_MODE_U_matcapTexture,SC_SOFTWARE_WRAP_MODE_V_matcapTexture).x==3;
}
#else
{
l9_53=(int(SC_USE_CLAMP_TO_BORDER_matcapTexture)!=0);
}
#endif
float l9_54=l9_48;
float l9_55=1.0;
sc_ClampUV(l9_54,matcapTextureUvMinMax.x,matcapTextureUvMinMax.z,l9_53,l9_55);
float l9_56=l9_54;
float l9_57=l9_55;
bool l9_58;
#if (SC_USE_CLAMP_TO_BORDER_matcapTexture)
{
l9_58=ivec2(SC_SOFTWARE_WRAP_MODE_U_matcapTexture,SC_SOFTWARE_WRAP_MODE_V_matcapTexture).y==3;
}
#else
{
l9_58=(int(SC_USE_CLAMP_TO_BORDER_matcapTexture)!=0);
}
#endif
float l9_59=l9_50;
float l9_60=l9_57;
sc_ClampUV(l9_59,matcapTextureUvMinMax.y,matcapTextureUvMinMax.w,l9_58,l9_60);
l9_52=l9_60;
...
#endif
vec2 l9_61=sc_TransformUV(l9_51,(int(SC_USE_UV_TRANSFORM_matcapTexture)!=0),matcapTextureTransform);
float l9_62=l9_61.x;
float l9_63=l9_52;
sc_SoftwareWrapLate(l9_62,ivec2(SC_SOFTWARE_WRAP_MODE_U_matcapTexture,SC_SOFTWARE_WRAP_MODE_V_matcapTexture).x,(int(SC_USE_CLAMP_TO_BORDER_matcapTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_matcapTexture)!=0)),l9_63);
float l9_64=l9_61.y;
float l9_65=l9_63;
sc_SoftwareWrapLate(l9_64,ivec2(SC_SOFTWARE_WRAP_MODE_U_matcapTexture,SC_SOFTWARE_WRAP_MODE_V_matcapTexture).y,(int(SC_USE_CLAMP_TO_BORDER_matcapTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_matcapTexture)!=0)),l9_65);
float l9_66=l9_65;
vec3 l9_67=sc_SamplingCoordsViewToGlobal(vec2(l9_62,l9_64),matcapTextureLayout,l9_46);
vec4 l9_68=texture2D(matcapTexture,l9_67.xy,0.0);
vec4 l9_69;
#if (SC_USE_CLAMP_TO_BORDER_matcapTexture)
{
l9_69=mix(matcapTextureBorderColor,l9_68,vec4(l9_66));
}
#else
{
l9_69=l9_68;
...
{
l9_70=pow(l9_41,Port_Input1_N087);
}
vec4 l9_71=vec4(l9_70);
vec4 l9_72=max(l9_42,mix(Port_Input0_N024,Port_Input1_N024,l9_71));
float l9_73=borderAlpha*l9_41;
float l9_74;
if (l9_29<=0.0)
{
l9_74=0.0;
...
{
l9_74=pow(l9_29,(((borderAlpha-Port_RangeMinA_N129)/(Port_RangeMaxA_N129-Port_RangeMinA_N129))*(Port_RangeMaxB_N129-Port_RangeMinB_N129))+Port_RangeMinB_N129);
}
float l9_75=(backingAlpha*Port_Input1_N052)*l9_74;
float l9_76=(isHovered*smoothstep(Port_Input0_N166*l9_1,Port_Input1_N165,l9_13))*smoothstep(Port_Input0_N157,Port_Input1_N157,(clamp(smoothstep((-Port_handleWidth_N104)*0.5,0.0,l9_30),0.0,1.0)-clamp(smoothstep(0.0,Port_handleWidth_N104*0.5,l9_30),0.0,1.0))*((((0.0+((l9_33*l9_36)*scaleHandles.x))+((l9_38*l9_36)*scaleHandles.y))+((l9_38*l9_40)*scaleHandles.z))+((l9_33*l9_40)*scaleHandles.w)));
vec4 l9_77=vec4(Port_Value1_N156.x,Port_Value1_N156.y,Port_Value1_N156.z,vec4(0.0).w);
l9_77.w=l9_76;
vec4 l9_78=mix(vec4((Port_Value_N151.xyz*l9_75)+((l9_72*vec4(Port_Input1_N149)).xyz*l9_73),max(l9_75,l9_73)),l9_77,vec4(l9_76));
vec3 l9_79=mix(Port_Input0_N055,mix(Port_Value_N073,Port_Value_N054,l9_18),vec3(l9_22))+l9_78.xyz;
float l9_80=l9_78.w*opacity;
vec4 l9_81=vec4(l9_79.x,l9_79.y,l9_79.z,vec4(0.0).w);
l9_81.w=l9_80;
if ((step(l9_80,Port_Input1_N093)*1.0)!=0.0)
{
discard;
}
...
{
l9_85=clamp(dot(l9_81.xyz,vec3(l9_80)),0.0,1.0);
}
#else
{
float l9_86;
...
{
l9_87=(1.0-dot(l9_81.xyz,vec3(0.33333001)))*l9_80;
}
#else
{
float l9_88;
...
{
l9_88=(1.0-clamp(dot(l9_81.xyz,vec3(1.0)),0.0,1.0))*l9_80;
}
#else
{
float l9_89;
...
{
l9_89=clamp(dot(l9_81.xyz,vec3(1.0)),0.0,1.0)*l9_80;
}
#else
{
float l9_90;
#if (sc_BlendMode_Add)
{
l9_90=clamp(dot(l9_81.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_91;
...
{
l9_92=dot(l9_81.xyz,vec3(0.33333001))*l9_80;
}
#else
{
float l9_93;
#if (sc_BlendMode_Min)
{
l9_93=1.0-clamp(dot(l9_81.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_94;
#if (sc_BlendMode_Max)
{
l9_94=clamp(dot(l9_81.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_94=1.0;
...
#endif
l9_82=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_81.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_83);
}
#else
{
vec4 l9_95;
...
#if (sc_FramebufferFetch)
{
vec4 l9_98=sc_readFragData0_Platform();
vec4 l9_99;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_100=l9_98;
l9_100.x=l9_98.x+_sc_framebufferFetchMarker;
l9_99=l9_100;
}
#else
{
...
#endif
l9_97=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_101,sc_ScreenTextureLayout,l9_102).xy,0.0);
}
#endif
vec4 l9_103;
...
{
vec4 l9_104=l9_97;
l9_104.x=l9_97.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_103=l9_104;
}
#else
{
...
#endif
vec3 l9_105=mix(l9_103.xyz,definedBlend(l9_103.xyz,l9_81.xyz).xyz,vec3(l9_80));
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_116-0.0039215689)),min(1.0,l9_116+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#endif
int l9_118=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_117).xy);
float l9_119=packValue(l9_118);
int l9_126=int(l9_115.w*255.0);
float l9_127=packValue(l9_126);
sc_writeFragData0(vec4(packValue(l9_118),packValue(l9_118),packValue(l9_118),packValue(l9_118)));
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_130).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_135==0)
{
l9_138=texture2D(sc_OITAlpha0,l9_130);
l9_137=texture2D(sc_OITDepthLow0,l9_130);
l9_136=texture2D(sc_OITDepthHigh0,l9_130);
}
else
{
l9_138=vec4(0.0);
...
if (l9_135==1)
{
l9_141=texture2D(sc_OITAlpha1,l9_130);
l9_140=texture2D(sc_OITDepthLow1,l9_130);
l9_139=texture2D(sc_OITDepthHigh1,l9_130);
}
else
{
l9_141=l9_138;
...
vec4 l9_156=texture2D(sc_OITFilteredDepthBoundsTexture,l9_130);
