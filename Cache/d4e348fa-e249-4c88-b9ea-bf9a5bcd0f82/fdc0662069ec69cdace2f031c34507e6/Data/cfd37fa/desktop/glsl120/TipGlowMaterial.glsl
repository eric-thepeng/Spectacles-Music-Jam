...
//sampler sampler mainTexSmpSC 0:17
...
//texture texture2D mainTex 0:1:0:17
...
sc_SoftwareWrapEarly(l9_1,ivec2(SC_SOFTWARE_WRAP_MODE_U_mainTex,SC_SOFTWARE_WRAP_MODE_V_mainTex).x);
float l9_2=l9_1;
float l9_3=varPackedTex.y;
sc_SoftwareWrapEarly(l9_3,ivec2(SC_SOFTWARE_WRAP_MODE_U_mainTex,SC_SOFTWARE_WRAP_MODE_V_mainTex).y);
float l9_4=l9_3;
vec2 l9_5;
float l9_6;
...
{
l9_7=ivec2(SC_SOFTWARE_WRAP_MODE_U_mainTex,SC_SOFTWARE_WRAP_MODE_V_mainTex).x==3;
}
#else
{
l9_7=(int(SC_USE_CLAMP_TO_BORDER_mainTex)!=0);
}
#endif
float l9_8=l9_2;
float l9_9=1.0;
sc_ClampUV(l9_8,mainTexUvMinMax.x,mainTexUvMinMax.z,l9_7,l9_9);
float l9_10=l9_8;
float l9_11=l9_9;
bool l9_12;
#if (SC_USE_CLAMP_TO_BORDER_mainTex)
{
l9_12=ivec2(SC_SOFTWARE_WRAP_MODE_U_mainTex,SC_SOFTWARE_WRAP_MODE_V_mainTex).y==3;
}
#else
{
l9_12=(int(SC_USE_CLAMP_TO_BORDER_mainTex)!=0);
}
#endif
float l9_13=l9_4;
float l9_14=l9_11;
sc_ClampUV(l9_13,mainTexUvMinMax.y,mainTexUvMinMax.w,l9_12,l9_14);
l9_6=l9_14;
...
#endif
vec2 l9_15=sc_TransformUV(l9_5,(int(SC_USE_UV_TRANSFORM_mainTex)!=0),mainTexTransform);
float l9_16=l9_15.x;
float l9_17=l9_6;
sc_SoftwareWrapLate(l9_16,ivec2(SC_SOFTWARE_WRAP_MODE_U_mainTex,SC_SOFTWARE_WRAP_MODE_V_mainTex).x,(int(SC_USE_CLAMP_TO_BORDER_mainTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_mainTex)!=0)),l9_17);
float l9_18=l9_15.y;
float l9_19=l9_17;
sc_SoftwareWrapLate(l9_18,ivec2(SC_SOFTWARE_WRAP_MODE_U_mainTex,SC_SOFTWARE_WRAP_MODE_V_mainTex).y,(int(SC_USE_CLAMP_TO_BORDER_mainTex)!=0)&&(!(int(SC_USE_UV_MIN_MAX_mainTex)!=0)),l9_19);
float l9_20=l9_19;
vec3 l9_21=sc_SamplingCoordsViewToGlobal(vec2(l9_16,l9_18),mainTexLayout,l9_0);
vec4 l9_22=texture2D(mainTex,l9_21.xy,0.0);
vec4 l9_23;
#if (SC_USE_CLAMP_TO_BORDER_mainTex)
{
l9_23=mix(mainTexBorderColor,l9_22,vec4(l9_20));
}
#else
{
l9_23=l9_22;
...
#endif
vec3 l9_24=vec3(tintColor.xyz)*vec3(l9_23.xyz);
float l9_25=((tintColor.w*l9_23.w)*brightness)*fadeLevel;
vec4 l9_26=vec4(l9_24.x,l9_24.y,l9_24.z,vec4(0.0).w);
l9_26.w=l9_25;
...
{
l9_30=clamp(dot(l9_26.xyz,vec3(l9_25)),0.0,1.0);
}
#else
{
float l9_31;
...
{
l9_32=(1.0-dot(l9_26.xyz,vec3(0.33333001)))*l9_25;
}
#else
{
float l9_33;
...
{
l9_33=(1.0-clamp(dot(l9_26.xyz,vec3(1.0)),0.0,1.0))*l9_25;
}
#else
{
float l9_34;
...
{
l9_34=clamp(dot(l9_26.xyz,vec3(1.0)),0.0,1.0)*l9_25;
}
#else
{
float l9_35;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_36=clamp(dot(l9_26.xyz,vec3(1.0)),0.0,1.0)*l9_25;
}
#else
{
float l9_37;
...
{
l9_37=dot(l9_26.xyz,vec3(0.33333001))*l9_25;
}
#else
{
float l9_38;
...
#endif
l9_42=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_46,sc_ScreenTextureLayout,l9_47).xy,0.0);
}
#endif
vec4 l9_48;
...
#endif
vec3 l9_50=mix(l9_48.xyz,definedBlend(l9_48.xyz,l9_26.xyz).xyz,vec3(l9_25));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_52=vec4(mix(vec3(1.0),l9_26.xyz,vec3(l9_25)),l9_25);
}
#else
{
vec4 l9_53;
