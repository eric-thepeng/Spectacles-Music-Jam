        ...
        for (const axis of rotationAxes) {
            ...
            switch (axis) {
                ...
                case RotationAxis.Y:
                    ...
                    if (forwardVector.dot(VEC3_UP) > 0.9) {
                        upVector = this.getForwardVector();
                    }
                    else {
                        upVector = VEC3_UP;
                    }
                    rotationQuaternion = this.yAxisCalculator.getRotation(upVector, this.getForwardVector(), targetToCamera, this.getRightVector().uniformScale(-1));
                    break;
                case RotationAxis.Z:
        ...
        for (const axis of rotationAxes) {
            ...
            switch (axis) {
                ...
                case RotationAxis.Y:
                    ...
                    rotationQuaternion = this.yAxisCalculator.resetRotation(upVector, this.getForwardVector(), targetToCamera, this.getRightVector().uniformScale(-1));
                    break;
                case RotationAxis.Z:
